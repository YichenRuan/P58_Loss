    ...
    public static class PShearWall
    {
        private static class ShearWallRecognizer
        {
            ...
            private static void GetBoundCond_and_Rein(int i)
            {
                ...
                {
                    int[] boundEle = { 2, 2 };          //0: shear wall, 1: column, 2: undefined
            ...
            private static bool TryGetFGCode(out string FGcode)
            {
                ...
                if (2.0 < _aspectRatio)                  //Rectangular & low-rise walls
                {
                    switch(_boundaryCondition)
                    {
                        case ShearWallBoundaryCondition.Rectangular:
                            ...
                            {
                                _abandonWriter.WriteAbandonment(_wall, AbandonmentTable.ShearWall_RectangularWallTooThick);
                                return false;
                            }
                            else if (16.0 * ConstSet.InchToFeet < _thickness)
                            {
                                ...
                                {
                                    _abandonWriter.WriteAbandonment(_wall, AbandonmentTable.ShearWall_ThickWallHasSingleCurtain);
                                    return false;
                                }
                                FGcode += "02";
                            }
                            ...
                            else
                            {
                                ...
                                {
                                    _abandonWriter.WriteAbandonment(_wall, AbandonmentTable.ShearWall_ThinWallHasDoubleCurtain);
                                    return false;
                                }
                                FGcode += "00";
                            }
                        ...
                        case ShearWallBoundaryCondition.ReturnFlange:
                            if (24.0 * ConstSet.InchToFeet < _thickness)
                            {
                                _abandonWriter.WriteAbandonment(_wall, AbandonmentTable.ShearWall_LowRiseWallTooThick);
                                return false;
                            }
                    ...
                    if (40 < _height)
                    {
                        _abandonWriter.WriteAbandonment(_wall, AbandonmentTable.ShearWall_UnSlenderWallTooHigh);
                        return false;
                    }
                ...
                else                                    //Slender Wall
                {
                    ...
                    {
                        _abandonWriter.WriteAbandonment(_wall, AbandonmentTable.ShearWall_SlenderWallTooThick);
                        return false;
                    }
                    ...
                    if (30 < _height)               //change it to 12
                    {
                        _abandonWriter.WriteAbandonment(_wall, AbandonmentTable.ShearWall_SlenderWallTooHigh);
                        return false;
                    }

                    if (30 < _length)
                    {
                        _abandonWriter.WriteAbandonment(_wall, AbandonmentTable.ShearWall_SlenderWallTooLong);
                        return false;
                    }
        ...
        private static void ExtractObjects()
        {
            ...
            foreach (Wall wall in shearWallCollector)
            {
                ...
                {
                    _abandonWriter.WriteAbandonment(wall, AbandonmentTable.StruWall_MatlOOR);
                }
            }
        }
