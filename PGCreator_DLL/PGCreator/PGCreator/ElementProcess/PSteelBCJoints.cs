...
{
    public static class PStealBCJoints
    {
        private static class JointsRecognizer
        {
            ...
            private static BeamSize GetBeamSize(FamilyInstance beam, Direction beamDire)
            {
                ...
                if (h <= 27 * ConstSet.InchToFeet) return BeamSize.W27;
                else if (30 * ConstSet.InchToFeet < h) return BeamSize.W30;
                else return BeamSize.Undefined;
            }
        ...
        private static void ExtractObjects()
        {
            ...
            _StruColumns = ColumnCollector.WherePasses(new ElementStructuralTypeFilter(StructuralType.Column))
                .WherePasses(new StructuralMaterialTypeFilter(StructuralMaterialType.Steel)).ToList();
        }
