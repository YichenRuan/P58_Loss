                ...
                if (_addiInfo.requiredComp[(byte)PGComponents.Ceiling])
                {
                    while (true)
                    {
                        ...
                        if (_addiInfo.defaultSet[(byte)DefaultSet.Ceiling_LateralSupport] == 0)     //w/o lat support
                        {
                            ...
                            {
                                _abandonWriter.WriteAbandonment(_ceiling, AbandonmentTable.CeilingSDCConflictLatSupport);
                                break;
                            }
                        }
                        else
                        {
                            ...
                            if (_addiInfo.defaultSet[(byte)DefaultSet.Ceiling_Ip] == 0)             //Ip = 1.0
                            {
                                ...
                                {
                                    _abandonWriter.WriteAbandonment(_ceiling, AbandonmentTable.CeilingSDCConflictIp);
                                    break;
                                }
                                else FGCode += "003";
                            }
