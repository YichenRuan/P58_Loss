    ...
    public static class PBeamColumnJoints
    {
        private static class JointsRecognizer
        {
            ...
            {   
                ...
                if (!isFound)
                {
                    _abandonWriter.WriteAbandonment(beam, AbandonmentTable.BeamFloorNotFound);
                    return;
                }
            ...
            private static void UpdateToGlobalRecord()
            {
                while (_bottom_floor <= _top_floor)
                {
                    ...
                    else if (2 < _num[0, _bottom_floor]) _abandonWriter.WriteAbandonment(_column, AbandonmentTable.TooManyBeamsAtOneJoint);
                    ...
                    else if (2 < _num[1, _bottom_floor]) _abandonWriter.WriteAbandonment(_column, AbandonmentTable.TooManyBeamsAtOneJoint);
                    ++_bottom_floor;
                }
            }
            public static void Recognization(Element column)
            {
                ...
                {
                    _abandonWriter.WriteAbandonment(column, AbandonmentTable.ColumnTooShort);
                    return;
                }
