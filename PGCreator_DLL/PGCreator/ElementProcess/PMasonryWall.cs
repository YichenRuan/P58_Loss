    ...
    public static class PMasonryWall
    {
        private static class MasonryWallRecognizer
        {
            ...
            private static bool TryGetFGCode(out string FGCode)
            {
                ...
                {
                    _abandonWriter.WriteAbandonment(_wall, AbandonmentTable.MasonryWallThicknessOOR);
                    return false;
                }
            ...
            public static bool Recognization(Wall wall)
            {
                ...
                {
                    _abandonWriter.WriteAbandonment(wall as Element, AbandonmentTable.WallBeyondRoof);
                }

                if (_floor_top <= _floor_bottom)
                {
                    _abandonWriter.WriteAbandonment(wall as Element, AbandonmentTable.WallTooShort);
                    return false;
                }
